...
<div className="sm:w-1/2 w-full bg-teal-100  flex justify-center items-center text-4xl p-8 text-teal-800">
<h1>
...
<div className="flex flex-col justify-center  bg-gradient-to-b from-[#f7f7f7] to-[#318580]  ">
